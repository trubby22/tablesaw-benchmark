...
//  }
//
//  public MyStandardTableSliceGroup shortBy(String... columnNames) {
//    MyStandardTableSliceGroup group;
//    try {
//      Method tdnc = Summarizer.class.getDeclaredMethod(
//          "tableDoesNotContain", String.class, Table.class);
//      Field tempF = Summarizer.class.getDeclaredField("temp");
...
//      }
//
//      group = MyStandardTableSliceGroup.create(tempV,
//          columnNames);
//    } catch (NoSuchMethodException | NoSuchFieldException |
//             IllegalAccessException | InvocationTargetException e) {
//      throw new RuntimeException(e);
...
//  }
//
//  public Table mySummarize(TableSliceGroup group) {
//    Table res;
//    try {
