...
////  private Table input;
////  private MySummarizer summarizer;
//  private MyStandardTableSliceGroup group;
//
...
//      MySummarizer summarizer = mySummarize(highestCaseloadByDay,
//          "smoothed", max);
//      group = summarizer.shortBy("date");
//
//    } catch (Throwable e) {
...
////  public void after() {
////    Table highestCaseloadByDay = summarizer.mySummarize(group);
////
...
////  }
//
//  private static MySummarizer mySummarize(
//      Table table,
//      String columName,
//      AggregateFunction<?, ?>... functions) {
//    return new MySummarizer(table, table.column(columName), functions);
//  }
//
//}
